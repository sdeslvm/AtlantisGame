...
protocol AtlantisWebStatusComparable {
...
enum AtlantisWebStatus: Equatable, AtlantisWebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: AtlantisWebStatus) -> Bool {
        switch (self, other) {
...
extension AtlantisWebStatus {
    static func == (lhs: AtlantisWebStatus, rhs: AtlantisWebStatus) -> Bool {
